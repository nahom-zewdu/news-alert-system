...
from app.api import routes_news, routes_alerts, routes_admin, routes_subscribers
...
api_v1.include_router(routes_subscribers.router, prefix="/subscribers", tags=["subscribers"])
